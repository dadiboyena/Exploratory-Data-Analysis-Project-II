...
Exploratory Data Analysis-Project Assignment-II
...
(EPA) is tasked with setting national ambient air quality standards for fine PM and for 
tracking the emissions of this pollutant into the atmosphere. Approximatly every 3 years, 
...
emissions data for 1999, 2002, 2005, and 2008. For each year, the table contains number of tons of 
...
For each plot you should
    ...
    reproduced. You must also include the code that creates the PNG file. Only include the code for a single plot 
